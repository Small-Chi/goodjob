<template>
            ...
            <template v-slot:activator="{ on, attrs }">
              <v-btn color="var(--color-white)" dark v-bind="attrs" v-on="on" class="btn2 textBlue rounded-0" plain
                max-height="20" style="border-left: 0;">
                成為發案者
              </v-btn>
            </template>
            <v-card>
                    ...
                    <v-row>
                      <v-col cols="12">
                        <v-text-field label="名稱" hint="中文字長度為 1 到 4 個字" :rules='inputRules1'
                          v-model="form.ownername" :state="state.name"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6">
                      ...
                      <v-col cols="12" sm="6">
                        <v-select v-model="form.position" :items="['教育', '科技', '廣告媒體', '設計', '餐旅', '新創', '寵物', '食品', '建築', '政府單位', '傳產', '攤販', '其他']" label="行業類別">
                        </v-select>
                      </v-col>
                      <v-col cols="12" sm="6">
                        <v-autocomplete v-model="form.technology"
                          ...
                          label="需求工具" multiple></v-autocomplete>
                      </v-col>
                      <v-col cols="12" sm="6">
                        <v-expansion-panels>
                          <v-expansion-panel>
